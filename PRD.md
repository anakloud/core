...
- No duplication of child profile data — resolved via federation from ParentUp at read time.
...
## 8. Open Questions
1. Auth/identity model — centralized (Anakloud) or per-app? Affects how GraphQL resolvers authorize cross-service requests.
